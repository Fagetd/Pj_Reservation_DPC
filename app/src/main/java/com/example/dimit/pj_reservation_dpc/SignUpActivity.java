...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void saveUserInformation(){
        ...
        //String admin = ed_admin.getText().toString().trim();

        UserInformation userInformation = new UserInformation(nom,prenom,adresse1,adresse2,lieuDit,codePostal,ville,numTelephone,societe,adressemail);
